...
var domain = "oodle";
var webhookToken = "eVsWuY9EgZG1eoR3Zt5perhp";
var apiToken = "xoxp-2914333581-2925517244-2927686033-1641b5";

var slack = new Slack(webhookToken, domain);
...
gameController.prototype.start = function(startingServe) {
  ...
  channel: "#pingpong",
  username: "OodlePong",
  text: "A game is about to commence."
...
gameController.prototype.scored = function(event) {
    ...
    console.log(game.score[playerID]);
